          ...
          <div class="col-md-3 col-xs-12" style="margin-top:1%;">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
            	<li class="breadcrumb-item active">Peraturan Difeksi</li>
            </ol>
          </div><!-- /rowmt -->
	                          ...
	                          <div class="modal-header" style="background:#737373;">
	                           ...
	                           <form action="save-disposisi-share.php" method="post">
	                            ...
	                            <div class="modal-footer">
	                              <input type="submit" name="deleteFilePDifeksi" id="deleteFilePDifeksi" class="btn btn-danger" style="width:30%;" value="Yes, Delete."/>
	                            </div>
	                          </form>
	                        </div>
	                      </div>
...
<!--main content end-->
      ...
      <footer class="site-footer" style="background: #737373;">
          <div class="text-center">
              ...
              <a href="Peraturan-difeksi.php" class="go-top">
