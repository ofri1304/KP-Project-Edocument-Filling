	                          ...
	                          <div class="modal-header" style="background:#737373;">
	                           ...
	                           <form action="save-disposisi-share.php" method="post">
	                            ...
	                            <div class="modal-footer">
	                              <input type="submit" name="deleteFileSKeluar" id="deleteFileSKeluar" class="btn btn-danger" style="width:30%;" value="Yes, Delete."/>
	                            </div>
	                          </form>
	                        </div>
	                      </div>
...
<!--main content end-->
      ...
      <footer class="site-footer" style="background: #737373;">
          <div class="text-center">
              ...
              <a href="surat-keluar.php" class="go-top">
