	                          ...
	                          <div class="modal-header" style="background:#737373;">
	                           ...
	                           <form action="save-disposisi-share.php" method="post">
	                            ...
	                            <div class="modal-footer">
	                              <input type="submit" name="deleteFileSEdaran" id="deleteFileSEdaran" class="btn btn-danger" style="width:30%;" value="Yes, Delete."/>
	                            </div>
	                          </form>
	                        </div>
	                      </div>
	                        ...
	                        <div class="modal-content">
	                          <div class="modal-header" style="background:#737373;">
	                           ...
	                           <form action="save-disposisi-share.php" method="post">
	                            ...
	                            <div class="modal-footer">
	                              <input type="submit" name="deleteFileMMasuk" id="deleteFileMMasuk" class="btn btn-danger" style="width:30%;" value="Yes, Delete."/>
	                            </div>
	                          </form>
	                        </div>
	                      </div>
...
<!--main content end-->
      ...
      <footer class="site-footer" style="background: #737373;">
          <div class="text-center">
              ...
              <a href="surat-edaran.php" class="go-top">
