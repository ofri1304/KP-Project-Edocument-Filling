	                          ...
	                          <div class="modal-header" style="background:#737373;">
	                           ...
	                           <form action="save-disposisi-share.php" method="post">
	                            ...
	                            <div class="modal-footer">
	                              <input type="submit" name="deleteFileSMasuk" id="deleteFileSMasuk" class="btn btn-danger" style="width:30%;" value="Yes, Delete."/>
	                            </div>
	                          </form>
	                        </div>
	                      </div>
				                            ...
				                            <td class="center"><?php echo $row['tgl_upload']; ?></td>
																	 ...
																	 <?php endif;?>
																		...
																		<?php $idfile = $row['idfile']; $nourutan2 = 0;
																			$share_array = get_data_share_file("SELECT * FROM share_file where idfile LIKE'".$idfile."'");
...
<!--main content end-->
      ...
      <footer class="site-footer" style="background: #737373;">
          <div class="text-center">
              ...
              <a href="surat-masuk.php" class="go-top">
